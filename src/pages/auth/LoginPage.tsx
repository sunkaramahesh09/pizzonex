...
export default function LoginPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (success) {
      ...
      navigate(email === "admin@pizza.com" ? "/admin" : "/dashboard");
    }
  };
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-background via-muted to-background">
      <Card className="w-full max-w-md shadow-2xl">
        <CardHeader className="text-center space-y-2 pb-2">
          ...
          <CardDescription>Sign in to your PizzaHub account</CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <p className="text-center text-xs text-muted-foreground mt-3">
            Demo: use <strong>admin@pizza.com</strong> for admin
          </p>
        </CardContent>
      </Card>
    </div>
